  ...
  insertarFichas() {
    ...
    this.imgArreglo.forEach((imagen) => {
      for (let i = 0; i < 2; i++) {
        ...
        imgOculta.src = '/asets/img/cartaOculta.png';
        imgOculta.style.width = '180px';
        imgOculta.style.position = 'absolute';

        this.agrandarImagenCursor(imgElement);
        this.agrandarImagenCursor(imgOculta);

        divRandom[contador].appendChild(imgOculta);
